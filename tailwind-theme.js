export default {
    ...
    global: {
      ...
      input:
        'appearance-none bg-[#263238] focus:outline-none focus:ring-0 focus:shadow-none',
    ...
    'family:text': { // info input text css
      inner:
        'flex items-center max-w-md rounded-xl ring-gray-400 focus-within:ring-[#ECEFF1] focus-within:ring-4 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
      input:
        'w-full px-3 py-2 border-none rounded-xl text-base text-[#ECEFF1] placeholder-gray-400',
    },
    'family:date': {
      inner:
    ...
    select: { //info select
      ...
      input:
        'w-full px-3 py-2 border-none rounded-xl text-base text-[#ECEFF1] placeholder-gray-400',
      // inner:
      //   'flex relative max-w-md items-center rounded-xl mb-1 ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-blue-500',
      // input:
      //   'w-full pl-3 pr-8 py-2 text-[#ECEFF1] rounded-xl border-none text-base placeholder-gray-400 formkit-multiple:p-0 data-[placeholder="true"]:text-gray-400 formkit-multiple:data-[placeholder="true"]:text-inherit',
      selectIcon:
